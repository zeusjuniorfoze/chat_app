...
<body>
    ...
    <div class="container">
        ...
        <div class="left-side">
            <div class="header">
                <div><a href="admin.php" style="font-size: 30px; color: black;"><i class="bx bx-left-arrow-alt"></i></a></div>
                ...
                <ul class="nav-icons">
                    ...
                    <li class="ellipsis-menu">
                        ...
                        <div class="dropdown-menu">
                            <ul class="options">
                                <li><ion-icon name="add-circle-outline" class=" bx bx-plus-circle"></ion-icon><a href="../groupe/cree_admin_group.php">Créer un groupe</a></li>
                            </ul>
                            <?php while ($membre = $recup->fetch()) { ?>
                                <ul class="members">
                                    <li>
                                        <a href="create_admin_discussion.php?id=<?php echo $membre['ID']; ?>">
                                            <div class="avatar">
    ...
    $.ajax({
        url: 'update_admin_chat_list.php',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
            ...
            data.forEach(function(chat) {
                ...
                if (chat.type === 'discussion') {
                    ...
                    chatList += `
                    <a style="text-decoration: none; color: black;" href="../groupe/tchat_admin_group.php?IDG=${chat.group_id}">
                        <div class="chat ${inCurrentChat ? 'active' : ''}">
                            <div class="imgBx">
...
$(document).ready(function() {
    loadChatList();
    setInterval(loadChatList, 5000); // Actualiser toutes les 5 secondes
});
        ...
        function loadDoc() {
            setInterval(function() {
                ...
                xhttp.open("GET", "afficheadmin.php", true);
                xhttp.send();
            }, 100);
        }
        loadDoc();
