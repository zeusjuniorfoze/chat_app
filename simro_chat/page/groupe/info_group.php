...
// requtte pour compter le nombre de membre dans le groupe
...
<body>
    ...
    <div class="contact-container light-theme">
        <a class="left-arrow-alt" href="tchat_group.php" style="font-size: 30px; color: black; padding: 100px; margin-top: -5%; position: absolute;"><i class="bx bx-left-arrow-alt"></i></a>
                ...
                <?php while ($b = $sql1->fetch()) { ?>
                    <li class="member">
                        ...
                        <div class="member-info">
                            ...
                            <a style=" text-decoration: none; color: red; font-size: 30px;" onclick="return confirm('Voulez Vous Suprimer Cet Utulisateur Du Groupe ?')" href="suprim_membre.php?ID=<?php echo $b['ID'] ?>"><i class="bx bx-trash"></i></a>
                    </li>
                <?php } ?>
            </ul>

            <!-- Bouton pour ajouter des membres au groupe -->
            <a style="text-decoration: none;" href="ajout_user_group.php"><button class="create-group-btn1" style="margin-bottom: 4%;"><i class='bx bx-plus-circle' style="font-size: 15px;"></i> Ajouter des membres au groupe</button></a>
