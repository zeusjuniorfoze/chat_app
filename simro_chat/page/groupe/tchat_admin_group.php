...
<body>
    <div class="container">
        ...
        <div class="left-side">
            <div class="header">
                <div><a href="../admin/admin.php" style="font-size: 30px; color: black;"><i class="bx bx-left-arrow-alt"></i></a></div>
                ...
                <ul class="nav-icons">
                    ...
                    <li class="ellipsis-menu">
                        <ion-icon name="ellipsis-vertical" class="bx bx-plus-circle" style="font-size: 40px;"></ion-icon>
                        <div class="dropdown-menu">
                            <ul class="options">
                                <li><ion-icon name="add-circle-outline" class=" bx bx-plus-circle"></ion-icon><a href="cree_admin_group.php">Créer un groupe</a></li>
                            </ul>
                            <?php while ($membre = $recup->fetch()) { ?>
                                <ul class="members">
                                    <li>
                                        <a href="../admin/create_admin_discussion.php?id=<?php echo $membre['ID']; ?>">
                                            <div class="avatar">
        ...
        <div class="right-side">
            <div class="header">
                <div class="user-details">
                    ...
                    <?php if ($result) { ?>
                        <a style=" text-decoration: none; color:black;" href="info_admin_group.php?IDG=<?php echo $result['IDG']; ?>">
    ...
    <script>
        ...
        function loadChatList() {
            $.ajax({
                url: '../admin/update_admin_chat_list.php',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    data.forEach(function(chat) {
                        if (chat.type === 'discussion') {
                            chatList += `
                                <a style="text-decoration: none; color: black;" href="../admin/tchatadmin.php?id=${chat.discussion_id}">
